...
import { Container, Card } from "./Style.termos";
  ...
  return (
    <Container>
      <Card>
        ...
        <p>
          A sua privacidade é importante para nós. É política do Lumi respeitar
          a sua privacidade em relação a qualquer informação sua que possamos
          coletar no site Lumi, e outros sites que possuímos e operamos.
        </p>
        <p>
        ...
        <p>
          ...
          nossas práticas em torno de Aviso de Privacidad e informações
        ...
        <h2>Política de Cookies Lumi</h2>
        ...
        <p>
          ...
          cookies geralmente serão excluídos quando você sair do sistema, porém,
          em alguns casos, eles poderão permanecer posteriormente para lembrar
        ...
        <p>
          ...
          informação que o Lumi oferece no site e com caráter enunciativo, mas
          não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do Lumi, de seus fornecedores ou terceiros, para
        ...
        <p>Esta política é efetiva a partir de 17 agosto 2022 03:53</p>
      </Card>
    </Container>
  );
}
